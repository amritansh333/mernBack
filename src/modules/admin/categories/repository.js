...
export const find = (query, { sort = {}, skip = 0, limit = 50 } = {}) => Category.find(query).sort(sort).skip(skip).limit(limit).lean();
...
export const updateById = (id, payload, opts = { new: true }) => Category.findByIdAndUpdate(id, payload, opts).lean();
