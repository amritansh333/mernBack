...
export const find = (query, { sort = {}, skip = 0, limit = 50 } = {}) => Brand.find(query).sort(sort).skip(skip).limit(limit).lean();
...
export const updateById = (id, payload, opts = { new: true }) => Brand.findByIdAndUpdate(id, payload, opts).lean();
