...
router.post("/", upload.uploadSingle("products"), asyncHandler(controller.createProduct));
router.put("/:id", upload.uploadSingle("products"), asyncHandler(controller.updateProduct));
router.patch("/:id", upload.uploadSingle("products"), asyncHandler(controller.updateProduct));
